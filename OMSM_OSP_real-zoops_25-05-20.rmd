...
```{r export_filename}
export.file.name <- "OMSM_posteriors_OSP.RData"
```
...
Data.zoops <- 
  subset(Data.zoops,
         ((Depth < 50 | Depth > 200)&
            (Event == "Night")) & 
           Size != "Neocalanus" & d15NPhe > -2.5) # Excluding neocalanus for its abnormally low d15N value
...
noquote("all zoops")
noquote("Posterior mode for f(small)")
min(subset(posts$f$mode, Size == "0.2-0.5 mm" | Size == "1-2 mm" | Size == "2-5 mm" | Size == ">5 mm")$Small)
mean(subset(posts$f$mode, Size == "0.2-0.5 mm" | Size == "1-2 mm" | Size == "2-5 mm" | Size == ">5 mm")$Small)
max(subset(posts$f$mode, Size == "0.2-0.5 mm" | Size == "1-2 mm" | Size == "2-5 mm" | Size == ">5 mm")$Small)
...
noquote("large zoops")
min(subset(posts$trophic$mode, Size == "2-5 mm" | Size == ">5 mm")$FWL)
mean(subset(posts$trophic$mode, Size == "2-5 mm" | Size == ">5 mm")$FWL)
max(subset(posts$trophic$mode, Size == "2-5 mm" | Size == ">5 mm")$FWL)
