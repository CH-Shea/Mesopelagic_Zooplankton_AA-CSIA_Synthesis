...
```{r export_filename}
export.file.name <- "OMSM_posteriors_5N.RData"
```
...
noquote("Posterior mode for f(small) from 200 to 1000 m")
noquote("small zoops")
min(subset(posts$f$mode, Depth > 200 & Depth < 1000)$Small)
mean(subset(posts$f$mode, Depth > 200 & Depth < 1000)$Small)
max(subset(posts$f$mode, Depth > 200 & Depth < 1000)$Small)
