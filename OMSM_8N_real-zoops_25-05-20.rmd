...
```{r export_filename}
export.file.name <- "OMSM_posteriors_8N.RData"
```
...
noquote("all zoops")
min(subset(posts$trophic$mode)$FWL)
mean(subset(posts$trophic$mode)$FWL)
max(subset(posts$trophic$mode)$FWL)
